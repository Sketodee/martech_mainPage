...
const AlumniProgramSections: React.FC = () => {
  ...
  const videoTestimonials = [
    {
      id: 1,
      youtubeId: "https://player.vimeo.com/video/1113005389", // Career change success story
      title: t("alumniProgramSections.alumni.videos.sarah.title")
    },
    {
      id: 2,
      youtubeId: "https://player.vimeo.com/video/1112617657", // Marketing career transition
      title: t("alumniProgramSections.alumni.videos.mark.title")
    },
    {
      id: 3,
      youtubeId: "https://player.vimeo.com/video/1112617703", // Tech skills development
  ...
  return (
    ...
    `}
      ...
      ${isMobile
                    ...
                    : 'duration-250 hover:scale-105 hover:-rotate-1'
                  }
    `}>
            ...
            transition-all ease-out
            ${isMobile ? 'duration-250' : 'duration-350'}
            ${isVisible
        ...
        `}
          ...
          `}
            style={{
              transitionDelay: isMobile ? '350ms' : '700ms'
            } as React.CSSProperties}
          >
            {viewMoreButton}
          </button>
        ...
        <div className="text-center">
          ...
          `}
            style={{
              transitionDelay: isMobile ? '500ms' : '700ms'
            } as React.CSSProperties}
          >
              ...
              <div
                ...
                className={`
                  ...
                  ${isMobile
                    ...
                    : 'duration-400 hover:scale-105 hover:-rotate-1'
                  }
                  ${isVisible
                    ? 'opacity-100 translate-y-0 scale-100 rotate-0'
                    : getAnimationClasses(
              ...
              >
                ...
                >
                  <div className={`
                    ...
                    hover:bg-blue-200 transition-all duration-150
                    ${isMobile
                      ? 'hover:scale-105'
